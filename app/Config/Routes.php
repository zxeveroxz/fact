...
//$routes->post('/login/validar', 'Login::index');

// Filter on single route
//$routes->get('home', 'Home::index', ['filter' => 'myauth']);
//$routes->get('home/index2', 'Home::index2', ['filter' => 'myauth']);

// Filter on group route
$routes->group('home', ['filter' => 'myauth'], function ($routes) {
