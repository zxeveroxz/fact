    ...
    <div class="container-fluid px-4 ">
        ...
        <div class="card  my-4 border border-1 border-dark">
            <div class="card-header bg-secondary text-white  border-bottom-1 border-dark py-0">
                ...
                <h4 class="m-0 py-2">CATEGORIAS
                    <a href="<?=base_url('categoria/form'); ?>" class="btn btn-sm btn-warning float-end "><i class="fas fa-plus-circle"></i> Nuevo</a>
                </h4>
            ...
            <div class="card-body">
                ...
                <table id="table"
                    ...
                    data-toggle="table" data-url="<?=base_url('categoria/listar_json'); ?>" data-side-pagination="server"
                    data-pagination="true" data-toolbar="#toolbar" data-query-params="queryParams">

                    <thead>
                        <tr>
                            <th data-field="idx" data-width="70" data-align="center" data-formatter="borrarFormatter">-
                            </th>
...
$(function() {
    $("#reset").click(function () {
        ...
        $("#valor").val("").focus();
        $("#table").bootstrapTable('refreshOptions', { url: '<?=base_url('categoria/listar_json'); ?>' });
    });
